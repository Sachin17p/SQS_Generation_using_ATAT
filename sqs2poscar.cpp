...
bool read_bestsqs (char *file, double dArrVec1[3][3], double dArrVec2[3][3],
                   double dArrAtom[10000][3], string strArrAtom[10000], int& nAtom,
...
int main (int argc, char* argv[]) {
    ...
    double dArrAtom[10000][3];    // atomic coordinates in bestsqs
    string strArrAtom[10000];     // atomic species in bestsqs
    int nAtom;                  // # of atoms
    ...
    double dArrAtom2[10000][3];   // atomic coordinates in POSCAR
    string strTemp;
    int count;
    double x, y, z;
    ...
    for (int i = 0; i < 3; i++) {   // line 3-5: lattice vectors
        for (int j = 0; j < 3; j++) {
            os << setw(15) << setprecision(8) << dArrLatVec[i][j];
        }
        os << endl;
    }
    ...
    for (int i = 0; i < nAtom; i++) {
        for (int j = 0; j < 3; j++) {
            os << setw(15) << setprecision(8) << dArrAtom2[i][j];
        }
        os << endl;
    }
    os.close();
